...
class MainWrapperBottomNavView extends GetView<MainWrapperBottomNavViewmodel> {
  ...
  final List<MainWrapperBottomNavModel> items = [
    MainWrapperBottomNavModel(title: 'Home', iconPath: FontAwesomeIcons.house,pageRoute: const MainWrapperHomeView()),
    MainWrapperBottomNavModel(title: 'Quest', iconPath: FontAwesomeIcons.questionCircle,pageRoute: const MainWrapperQuestView()),
    MainWrapperBottomNavModel(title: 'Wallet', iconPath: FontAwesomeIcons.wallet,pageRoute:  MainWrapperWalletView()),
  ];
